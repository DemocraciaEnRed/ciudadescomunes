      ...
      <div class="container">
        <div class="columns">
          <div class="column is-one-third is-4 has-text-centered-touch">
            ...
            <h1 class="title is-3 larger animated pulse slower infinite"><a class="has-text-white" href="https://docs.google.com/forms/d/e/1FAIpQLScDaAmLfhjvcF7mxSaJxZ1jo9Zs-Q17HV_PgSyvUX6vxXEwPg/viewform" target="_blank"><u>suscribite</u></a></h1>
          </div>
