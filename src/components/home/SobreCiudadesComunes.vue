        ...
        <div class="columns is-centered is-variable is-1-mobile is-8-tablet">
          <div class="column is-7">
            ...
            <div class="content has-text-centered">
                ...
                <p>Busca acompañar y generar propuestas que pongan en el centro la vida para construir un nuevo sentido común que permita repensar de una manera más justa las ciudades del mañana y su entramado social</p>
            </div>
            <br>
            <img src="@/assets/img/cc-icon-color.png" class="image is-centered" width="80" style="border-radius: 500px;" alt="">
          </div>
        </div>
      </div>
    </div>
